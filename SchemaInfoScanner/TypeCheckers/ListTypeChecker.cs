...
internal static class ListTypeChecker
{
        ...
        ILogger logger)
    {
        ...
        {
            throw new TypeNotSupportedException($"{property.PropertyName.FullName} is not supported list type. {nameof(SingleColumnCatalogAttribute)} can only be used in primitive type list.");
        }
