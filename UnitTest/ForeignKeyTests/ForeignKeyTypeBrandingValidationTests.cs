...
public class ForeignKeyTypeBrandingValidationTests(ITestOutputHelper testOutputHelper)
{
    ...
    public async Task Load_EnumBrandedFk_Succeeds()
    {
        ...
        Assert.Equal(3, staticData.HeroTable.Records.Length);
        Assert.Equal(3, staticData.HeroQuestTable.Records.Length);
    ...
    public async Task Load_RecordBrandedFk_Succeeds()
    {
        ...
        Assert.Equal(3, staticData.CharacterTable.Records.Length);
        Assert.Equal(3, staticData.CharacterQuestTable.Records.Length);
    ...
    public async Task Load_EnumBrandedSfk_Succeeds()
    {
        ...
        Assert.Equal(4, staticData.FaceLookupTable.Records.Length);
    ...
    public async Task Load_RecordBrandedSfk_Succeeds()
    {
        ...
        Assert.Equal(4, staticData.PartLookupTable.Records.Length);
