    ...
    namespace InnerMyProject
    {
        namespace InnerInnerMyProject
        {
            public sealed record MyRecord
            {
                ...
                {
                    public record InnerInnerRecord(string Name, int Score);

                    public InnerInnerRecord InnerInner { get; init; }
                }
...
// TODO 다른 파일에 정의된 enum 지원해야 함
    ...
    public sealed record FooRecord(
        [Key] [Order] [ColumnName("Tid")] int Id,
        ...
        [Order]
        [ColumnPrefix("DictionaryValueValue")]
        Dictionary<int, int> DictionaryValueValues,
        [Order]
        [ColumnPrefix("DictionaryValueString")]
        Dictionary<int, string> DictionaryValueStrings,
        [Order]
        [ColumnPrefix("DictionaryStringValue")]
        Dictionary<string, int> DictionaryStringValues,
        [Order]
        [ColumnPrefix("DictionaryStringString")]
        Dictionary<string, string> DictionaryStringStrings,
        [Order]
        [ColumnPrefix("DictionaryEnum")]
        Dictionary<Fruit, string> DictionaryEnums,
        [Order]
        [ColumnPrefix("DictionaryValueEnum")]
        Dictionary<int, Fruit> DictionaryValueEnums,
        [Order]
        [ColumnPrefix("DictionaryValueObjectA")]
        Dictionary<int, StudentWithIntKey> Students,
        [Order]
        [ColumnPrefix("DictionaryValueObjectB")]
        Dictionary<string, UserScoreWithStringkey> DictionaryValueObjects,
        [Order]
        [ColumnPrefix("DictionaryValueObjectB")]
        Dictionary<Fruit, FruitData> DictionaryEnumKey,
        ...
        [Order]
        [ColumnPrefix("DictionaryKeyErr")]
        Dictionary<Person, FruitData> DictionaryKeyErrs,

        // Value에 class 및 KeyAttribute가 없는 class는 지원하지 않음
        [Order]
        [ColumnPrefix("DictionaryValueClassErr")]
        Dictionary<string, Person> DictionaryValueClassErrs,
